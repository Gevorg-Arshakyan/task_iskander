  ...
  <header class="bg-[#2D82BE] text-white">
    ...
    <div class="bg-[#2D82BE]">
      <div class="max-w-[1240px] mx-auto">
        <div class="flex items-center justify-between h-[70px] gap-[22px]">
          <!-- Left: Logo -->
          <div class="flex items-center gap-12">
            ...
            <button
              ...
              class="flex items-center space-x-2 bg-[#0000001A] text-white px-4 py-2 rounded-full hover:bg-[#0000001A] transition-colors"
            >
              ...
              <span class="font-medium text-[15px] leading-[100%]">Каталог</span>
            </button>
          </div>
          ...
          <div class="flex-1 w-full">
            <div class="relative">
              <input
                ...
                type="text"
                placeholder="Поиск"
                class="w-full  px-10 py-2 border bg-white  text-[#949494] rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                @keyup.enter="handleSearch"
              />
              <svg
                class="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#949494] w-4 h-4"
                width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="7.49142" cy="7.49142" r="6.74142" stroke="#949494" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.1802 12.5303L14.8232 15.1665" stroke="#949494" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              <span class="absolute top-1/2 transform -translate-y-1/2 right-5 text-[#949494] font-medium text-[13px] leading-[24px]">42903</span>
            </div>
          </div>
          ...
          <div class="flex items-center gap-2.5">
            ...
            <div class="text-right">
              <p class="text-sm text-white font-normal text-[10px] leading-[100%]">Добро пожаловать</p>
              <button @click="handleAuthClick" class=" text-white hover:text-gray-200 font-semibold text-[14px] leading-[100%]">
                Вход/Регистрация
              </button>
            </div>
